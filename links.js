...
<body>
  ...
  <a href="https://404.weizhen.xyz/" target="_self"></a>
</body>`
...
async function handleRequest(request) {
  ...
  if(!path){
    ...
    const html= await fetch("https://cdn.weizhen.xyz/https://vip-weizhen.github.io/links.github.io/"+config.theme+"/index.html")
